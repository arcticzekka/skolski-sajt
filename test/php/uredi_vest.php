...
if(isset($_POST['submit'])){
	...
	$sql="UPDATE sajt SET vest='$vest', imeucenika='$imeucenika', predmet='$predmet', takmicenje='$takmicenje', opisvesti='$opisvesti' WHERE id=$id";
...
<form method="POST">
	...
	<br>
	<label>Predmet:</label>
	<input type="checkbox" name="predmet" value="Matematika" <?php if(in_array("Matematika",explode(",",$vest['predmet']))) echo "checked"; ?>> Matematika
	<input type="checkbox" name="predmet" value="Fizika" <?php if(in_array("Fizika",explode(",",$vest['predmet']))) echo "checked"; ?>> Fizika
	<input type="checkbox" name="predmet" value="Programiranje" <?php if(in_array("Programiranje",explode(",",$vest['predmet']))) echo "checked"; ?>> Programiranje
	<br>
