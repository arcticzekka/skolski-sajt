...
<html data-wf-page="645bad6daab2f46f8997b3c9" data-wf-site="6456c2138619102a79ba202a">
<head>
  <meta charset="utf-8">
  <title>Веб тим</title>
  <meta content="web tim" property="og:title">
  <meta content="web tim" property="twitter:title">
...
<body>
  <div data-animation="default" class="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="all" style="background-color:rgb(255,255,255)" data-w-id="07882184-ec71-1233-e03f-e05d0c913d81" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
    <div class="container nav-container">
      <a href="index.php" class="w-nav-brand"><img src="images/grb.png" loading="lazy" sizes="90px" srcset="images/grb.png 500w, images/grb.png 800w, images/grb.png 1000w" alt="" class="image-17"></a>
  ...
  <section class="web-team wf-section">
    <div class="container team-container">
      <div class="team-heading-title">
        <h1 class="main-team-heading">Веб Тим</h1>
      </div>
      <div class="first-team-row">
        <div class="creator-column"><img src="images/Rectangle-71.png" loading="lazy" alt="">
          <div class="creator-text">Име и презиме</div>
          <div class="creator-text">Смер и одељење</div>
          <h2 class="creator-job">Дизајн веб сајта</h2>
        </div>
        <div class="creator-column"><img src="images/Rectangle-71.png" loading="lazy" alt="">
          <div class="creator-text">Име и презиме</div>
          <div class="creator-text">Смер и одељење</div>
          <h2 class="creator-job">Front-end developer</h2>
        </div>
        <div class="creator-column"><img src="images/Rectangle-71.png" loading="lazy" alt="">
          <div class="creator-text">Име и презиме</div>
          <div class="creator-text">Смер и одељење</div>
      ...
      <div class="first-team-row row2">
        <div class="creator-column"><img src="images/Rectangle-71.png" loading="lazy" alt="">
          <div class="creator-text">Име и презиме</div>
          <div class="creator-text">Смер и одељење</div>
          <h2 class="creator-job">Back-end developer</h2>
        </div>
        <div class="creator-column"><img src="images/Rectangle-71.png" loading="lazy" alt="">
          <div class="creator-text">Име и презиме</div>
          <div class="creator-text">Смер и одељење</div>
      ...
      <div class="website-projects-text">
        <p class="paragraph">Школски веб сајт редизајниран је у школској 2022/2023. години у оквиру секције за програмирање и веб програмирање. Израду комплетног решења веб сајта реализовао је тим ученика. Током реализације овог задатка, ученици су додатно развили стечене вештине и компетенције током школовања на смеровима електротехничар информационих технологија и електротехничар рачунара.<br>‍<br>Ментори ученика на овом пројекту су:<br>Марија Пешић<br>дипломирани инжењер електротехнике<br>наставник групе предмета - подручје рада електротехника<br><br>и<br><br>Стефан Вуковић<br>дипломирани инжење информационих технологија<br>наставник групе предмета - подручје рада електротехника</p>
      </div>
    </div>
  </section>
  <section class="web-team wf-section"></section>
    ...
    <div class="container-2">
      <div class="w-row">
        <div class="column-7 w-col w-col-2">
          <div class="projets-title-line footer-line"></div><img src="images/grb.png" loading="lazy" sizes="(max-width: 767px) 120px, (max-width: 991px) 14vw, 120px" srcset="images/grb.png 500w, images/grb.png 800w, images/grb.png 1000w" alt="" class="image-16">
        </div>
        <div class="column-7 w-col w-col-2">
        ...
        <div class="column-10 w-col w-col-2">
          <a href="web-tim.php" aria-current="page" class="footer-link w--current">веб тим</a>
