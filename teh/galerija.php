...
<html data-wf-page="6457a4533f03ef6508b58dea" data-wf-site="6456c2138619102a79ba202a">
<head>
  <meta charset="utf-8">
  <title>Галерија</title>
  <meta content="Projects-page" property="og:title">
  <meta content="Projects-page" property="twitter:title">
...
<body>
  <div data-animation="default" class="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="all" style="background-color:rgb(255,255,255)" data-w-id="0e046ab9-ece2-d9ea-550a-0cd0fd0f44df" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
        ...
        <nav role="navigation" class="nav-menu w-nav-menu">
          <div class="container nav-menu-container">
            <div class="menu-links">
              ...
              <a href="projects-page.php" aria-current="page" class="menu-link w-nav-link w--current">НАСТАВНИ МАТЕРИЈАЛИ</a>
  ...
  <div class="projects projects-page wf-section">
    <div class="projects-title">
      <h2 class="projects-title-heading">Галерија</h2>
    ...
    <div class="container projects-container projects-page-container page-ofix-container" >
        <div class ="row-page" style="align-items: center;display: flex; justify-content: center;">
        <div class="card-page1 card-project card-page-project card-only" >
          <div class="card-content card-content-projects">
            <img src="images/Rectangle-64-1.png" loading="lazy" sizes="(max-width: 1299px) 100vw, 1299px" srcset="images/Rectangle-64-p-500.png 500w, images/Rectangle-64-p-800.png 800w, images/Rectangle-64-p-1080.png 1080w, images/Rectangle-64-1.png 1299w" alt="" class="image-14" >
        ...
        <div class="container projects-container projects-page-container page-ofix-container" style="border-top: none;">
        <div class ="row-page" style="align-items: center;display: flex; justify-content: center; ">
        <div class="card-page1 card-project card-page-project card-only" >
          <div class="card-content card-content-projects">
            <img src="images/Rectangle-64-1.png" loading="lazy" sizes="(max-width: 1299px) 100vw, 1299px" srcset="images/Rectangle-64-p-500.png 500w, images/Rectangle-64-p-800.png 800w, images/Rectangle-64-p-1080.png 1080w, images/Rectangle-64-1.png 1299w" alt="" class="image-14" >
      ...
      <div class="row-page" style="margin-top: -100px;">
        <div class="container projects-container projects-page-container page-ofix-container" style="border-top: none;">
          <div class ="row-page" style="align-items: center;display: flex; justify-content: center;">
          <div class="card-page1 card-project card-page-project card-only" >
            <div class="card-content card-content-projects">
    ...
    <div class="container-2">
      <div class="w-row">
        ...
        <div class="column-9 w-col w-col-2">
          ...
          <a href="projects-page.php" aria-current="page" class="footer-link w--current">Пројекти</a>
        </div>
        ...
        <div class="column-13 w-col w-col-2">
          <a href="projects-page.php" aria-current="page" class="footer-link w--current">Наставни материјал</a>
          <a href="rasporedi.php" class="footer-link">Распореди</a>
          <a href="javne-nabavke.php" class="footer-link">Јавне набавке</a>
          <a href="finansijski-izvjestaj.php" class="footer-link">Финансиjски извештаји</a>
        </div>
