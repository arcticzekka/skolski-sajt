...
<html data-wf-page="64576e92ba0880d46e08b4c5" data-wf-site="6456c2138619102a79ba202a">
<head>
  <meta charset="utf-8">
  <title>Распореди</title>
  <meta content="rasporedi" property="og:title">
  <meta content="rasporedi" property="twitter:title">
...
<body>
  <div data-animation="default" class="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="all" style="background-color:rgb(255,255,255)" data-w-id="dc1dc4fc-c41e-e90d-3df1-35998c9739cf" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
        ...
        <nav role="navigation" class="nav-menu w-nav-menu">
          <div class="container nav-menu-container">
            <div class="menu-links">
              ...
              <a href="rasporedi.php" aria-current="page" class="menu-link w-nav-link w--current">РАСПОРЕДИ</a>
  ...
  <div class="ucenici-hero wf-section">
    <h1 class="ucenici-heading">РАСПОРЕДИ</h1>
    <div class="ucenici-text">Овде можете преузети распореде часова за парну и непарну смену.</div>
      <div class="btns-rasporedi-wrapper">
          <a data-w-id="ba5af1aa-512e-f1f8-d4c9-c7ce57ae6a66" href="/uploads/raspored/parna.pdf" download
             class="op-btn-wrapper prica-btn projects-btn btn-white w-inline-block">
              <div class="op-section-list op-section-btn projects-btn op-btn-white2 btn-text-white">Преузмите распоред
                  за парну смену

              </div>
              <img src="images/right-1.png" loading="lazy"
          ...
          <a data-w-id="ba5af1aa-512e-f1f8-d4c9-c7ce57ae6a66" href="/uploads/raspored/neparna.pdf" download
             class="op-btn-wrapper prica-btn projects-btn btn-white w-inline-block">
              <div class="op-section-list op-section-btn projects-btn op-btn-white2 btn-text-white">Преузмите распоред
                  за непарну смену
    ...
    <div class="container-2">
      <div class="w-row">
        ...
        <div class="column-13 w-col w-col-2">
          ...
          <a href="rasporedi.php" aria-current="page" class="footer-link w--current">Распореди</a>
