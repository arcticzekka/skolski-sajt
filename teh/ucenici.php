...
<html data-wf-page="645769a85b320932380ef584" data-wf-site="6456c2138619102a79ba202a">
<head>
  <meta charset="utf-8">
  <title>Ученииц</title>
  <meta content="ucenici" property="og:title">
  <meta content="ucenici" property="twitter:title">
...
<body>
  <div data-animation="default" class="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="all" style="background-color:rgb(255,255,255)" data-w-id="e896d163-5fdc-769a-c35a-0386634a5c0e" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
    <div class="container nav-container">
      ...
      <div class="nav-wrapper">
        <nav role="navigation" class="nav-menu w-nav-menu">
          <div class="container nav-menu-container">
            <div class="menu-links">
              ...
              <a href="ucenici.php" aria-current="page" class="menu-link menu-hide w-nav-link w--current">ЗА УЧЕНИКЕ</a>
        ...
        <div style="display:flex" class="nav-links">
          ...
          <a href="ucenici.php" aria-current="page" class="nav-link w-nav-link w--current">ЗА УЧЕНИКЕ</a>
        </div>
  ...
  <div class="cards-ucenici wf-section">
    <div class="container projects-container">
      <div class="card-page1 card-project">
        <div class="card-content card-content-projects"><img src="images/Rectangle-24.png" loading="lazy" sizes="(max-width: 767px) 81vw, (max-width: 991px) 45vw, 33vw" srcset="images/Rectangle-24-p-500.png 500w, images/Rectangle-24.png 696w" alt="" class="card-img card-img-project">
          <div class="card-projects-text-wrapper">
            ...
            <a data-w-id="b114a153-fe49-4cb5-f7b5-9cf4f84b3903" href="#" class="op-btn-wrapper prica-btn projects-btn btn-white btn-black w-inline-block">
              <div class="op-section-list op-section-btn projects-btn op-btn-white2">Сазнај више</div><img src="images/right-2.png" loading="lazy" style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);transform-style:preserve-3d" alt="" class="op-img">
            </a>
          </div>
        </div>
      </div>
      <div class="card-page1 card-project card-purple">
        <div class="card-content card-content-projects"><img src="images/Rectangle-24.png" loading="lazy" sizes="(max-width: 767px) 81vw, (max-width: 991px) 45vw, 33vw" srcset="images/Rectangle-24-p-500.png 500w, images/Rectangle-24.png 696w" alt="" class="card-img card-img-project">
          <div class="card-projects-text-wrapper">
            <div class="op-section-list project-title op-white">Пројекат очувања животне средине</div>
            <div class="text-block-2 op-white">Lorem ipsum dolor sit amet, consectetur adipiscingelit, sed do eiusmod tempor incididunt ut labore etdolore magna aliqua.</div>
            <a data-w-id="b4a355c8-63f6-0db2-fbfa-ace65da364da" href="#" class="op-btn-wrapper prica-btn projects-btn btn-white w-inline-block">
              <div class="op-section-list op-section-btn projects-btn op-btn-white2 btn-text-white">Сазнај више</div><img src="images/right-1.png" loading="lazy" style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);transform-style:preserve-3d" alt="" class="op-img">
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="container-2">
      <div class="w-row">
        ...
        <div class="column-10 w-col w-col-2">
          ...
          <a href="ucenici.php" aria-current="page" class="footer-link w--current">За ученике</a>
        </div>
