...
<div class="project-desc-section wf-section">
    ...
    $id = $_GET["id"];
    $projekat = $projektiClass->selectProjekat($id);
    $slike = $projektiClass->getProjekatFiles($id);

    ?>
    <h1 class="project-desc-title"><?= $projekat["naslov"] ?></h1>
    <div class="project-img-wrapper"><img src="/uploads/skola_dokumenta/<?= $slike[0]["uploadedFileName"] ?>" loading="lazy" sizes="(max-width: 1299px) 100vw, 1299px" srcset="/uploads/skola_dokumenta/<?= $slike[0]["uploadedFileName"] ?> 500w, /uploads/skola_dokumenta/<?= $slike[0]["uploadedFileName"]?> 800w, /uploads/skola_dokumenta/<?= $slike[0]["uploadedFileName"]?> 1080w, /uploads/skola_dokumenta/<?= $slike[0]["uploadedFileName"]?> 1299w" alt="" class="image-12"></div>
