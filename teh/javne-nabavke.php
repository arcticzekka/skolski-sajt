...
<html data-wf-page="6457a2f03091d50f425fa818" data-wf-site="6456c2138619102a79ba202a">
<head>
  <meta charset="utf-8">
  <title>Javne nabavke</title>
  <meta content="javne nabavke" property="og:title">
  <meta content="javne nabavke" property="twitter:title">
...
<body>
  <div data-animation="default" class="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="all" style="background-color:rgb(255,255,255)" data-w-id="2628402e-8b91-57d9-8d80-5373bb5b9aa7" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
        ...
        <nav role="navigation" class="nav-menu w-nav-menu">
          <div class="container nav-menu-container">
            <div class="menu-links">
              ...
              <a href="javne-nabavke.php" aria-current="page" class="menu-link w-nav-link w--current">ЈАВНЕ НАБАВКЕ</a>
  ...
  <div class="ucenici-hero nabavke-hero wf-section">
    <h1 class="ucenici-heading">ЈАВНЕ НАБАВКЕ</h1>
...
<!--      <a data-w-id="ba5af1aa-512e-f1f8-d4c9-c7ce57ae6a66" href="#" class="op-btn-wrapper prica-btn projects-btn btn-white w-inline-block">-->
      <div class="btns-rasporedi-wrapper">
        <div data-w-id="ba5af1aa-512e-f1f8-d4c9-c7ce57ae6a66" class="op-btn-wrapper prica-btn projects-btn btn-white w-inline-block dropdown" id="dropdown">
        <div class="op-section-list op-section-btn projects-btn op-btn-white2 btn-text-white dropdown-toggle">Преузмите извештај јавних набавки</div>
         
          <img src="images/right-1.png" loading="lazy" style="-webkit-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0, 0);transform-style:preserve-3d" alt="" class="op-img" >
          <div class="dropdown-content">
            <?php
            include "../classes/Files.php";
            $fileClass = new Files();
            $files = $fileClass->getFiles(2);
            foreach($files as $file) {
            ?>
                <a href="/uploads/javne_nabavke/<?= $file["uploadedFileName"] ?>" download ><?= $file["filename"] ?></a>
              <?php } ?>
         </div>
        </div>
      </div>
    ...
    <div class="container-2">
      <div class="w-row">
        ...
        <div class="column-13 w-col w-col-2">
          ...
          <a href="javne-nabavke.php" aria-current="page" class="footer-link w--current">Јавне набавке</a>
