...
<html data-wf-page="64577a9b5b32094e620fd9e6" data-wf-site="6456c2138619102a79ba202a">
<head>
  <meta charset="utf-8">
  <title>Такмичења</title>
  <meta content="takmicenja" property="og:title">
  <meta content="takmicenja" property="twitter:title">
...
<body>
  <div data-animation="default" class="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="all" style="background-color:rgb(255,255,255)" data-w-id="13c4d2da-20b0-0422-09e0-7f9d7c3241b5" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
        ...
        <nav role="navigation" class="nav-menu w-nav-menu">
          <div class="container nav-menu-container">
            <div class="menu-links">
              ...
              <a href="takmicenja.php" aria-current="page" class="menu-link w-nav-link w--current">ТАКМИЧЕЊА</a>
  ...
  <div class="ucenici-hero wf-section" style=" height:1100px;">
    <h1 class="ucenici-heading " style="margin-top: -2%;" >Такмичења</h1>
    ...
    <div class="container-2">
      <div class="w-row">
        ...
        <div class="column-10 w-col w-col-2">
          ...
          <a href="takmicenja.php" aria-current="page" class="footer-link w--current">Такмичења</a>
