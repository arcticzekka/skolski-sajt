...
<html data-wf-page="645bad900c9766550d72745f" data-wf-site="6456c2138619102a79ba202a">
<head>
  <meta charset="utf-8">
  <title>Контакт информације</title>
  <meta content="kontakt-informacije" property="og:title">
  <meta content="kontakt-informacije" property="twitter:title">
...
<body>
  <div data-animation="default" class="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="all" style="background-color:rgb(255,255,255)" data-w-id="23104035-a779-caee-6308-28070bc0a702" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
      ...
      <div class="contact-info">
        <div class="row-flex">
          <div class="_1contact"><img src="images/icons8-gmail.png" loading="lazy" alt="">
            <div class="text-block-8">Gmail:</div>
            <a href="#" class="link">info@tehnickacacak.edu.rs</a>
          </div>
          <div class="_1contact"><img src="images/icons8-instagram.png" loading="lazy" alt="">
            <div class="text-block-8">Инстаграм профил:</div>
          </div>
        </div>
        <div class="row-block">
          <div class="_1contact"><img src="images/icons8-phone-100.png" loading="lazy" alt="">
            <div class="text-block-8">Телефон::</div>
            <a href="#" class="link">+3816802020202</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container-2">
      <div class="w-row">
        ...
        <div class="column-9 w-col w-col-2">
          ...
          <a href="kontakt-informacije.php" aria-current="page" class="footer-link w--current">Контакт информације</a>
