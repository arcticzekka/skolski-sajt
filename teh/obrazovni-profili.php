...
<html data-wf-page="64577afd6ea1db0f544e04d7" data-wf-site="6456c2138619102a79ba202a">
<head>
  <meta charset="utf-8">
  <title>Образовни профили</title>
  <meta content="obrazovni-profili" property="og:title">
  <meta content="obrazovni-profili" property="twitter:title">
...
<body>
  <div data-animation="default" class="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="all" style="background-color:rgb(255,255,255)" data-w-id="4f92b2b9-0c5f-771e-6d3c-37b122a94db6" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
        ...
        <nav role="navigation" class="nav-menu w-nav-menu">
          <div class="container nav-menu-container">
            <div class="menu-links">
              ...
              <a href="obrazovni-profili.php" aria-current="page" class="menu-link menu-hide w-nav-link w--current">ОБРАЗОВНИ ПРОФИЛИ</a>
  ...
  document.getElementById("currentYear2").innerText = currentYear;
        ...
        <div style="display:flex" class="nav-links">
          ...
          <a href="obrazovni-profili.php" aria-current="page" class="nav-link w-nav-link w--current">ОБРАЗОВНИ ПРОФИЛИ</a>
  ...
  <div class="obrazovni-profili-hero ob-white profili-page wf-section">
    <div class="container ob-container ob-page-container">
      <div class="op-left op-page-left">
        <h2 class="heading-prica ob-2-heading ob-page-heading">ОБРАЗОВНИ ПРОФИЛИ</h2>
        <div class="line-down"></div>
        <div class="text-block-2 ob-2-text ob-page-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod temporincididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrudexercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
      </div>
      <div class="op-right">
          <?php
          ...
          foreach($smerovi as $smer) {
              ?>
              <a data-w-id="05c7aaac-36b6-019e-d451-7bf0f3afb4f5" href="smer-info.php?smer=<?=$smer["id"]?>" class="smer-info-link first-info w-inline-block">
                  <div id="w-node-befb8aa4-820e-2ef7-0f3b-e27a40ef5678-544e04d7" class="op-section-list section-list-wrapper first-info">
                      <h2 class="op-section-list"><?= $smer["smer"] ?></h2>
                      <div style="display:none;-webkit-transform:translate3d(5%, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(5%, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(5%, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(5%, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)" class="hide-btn-wrapper">
                          <div class="hide-text">Сазнајте више</div><img src="images/right-3.png" loading="lazy" alt="" class="image-15">
                      </div>
                  </div>
              </a>
          <?php } ?>
    ...
    <div class="container-2">
      <div class="w-row">
        ...
        <div class="column-10 w-col w-col-2">
          ...
          <a href="obrazovni-profili.php" aria-current="page" class="footer-link w--current">Образовни профили</a>
          <div class="projets-title-line footer-line"></div>
