...
<html data-wf-page="645bad9bdedbd3e380605849" data-wf-site="6456c2138619102a79ba202a">
<head>
  <meta charset="utf-8">
  <title>Финансијски извештај</title>
  <meta content="finansijski-izvjestaj" property="og:title">
  <meta content="finansijski-izvjestaj" property="twitter:title">
...
<body>
  <div class="ucenici-hero fin-izvjestaj wf-section">
    <h1 class="ucenici-heading">ФИНАНСИЈСКИ ИЗВЕШТАЈИ</h1>
    ...
    <div class="btns-rasporedi-wrapper">
        <div class="btns-rasporedi-wrapper">
            <div data-w-id="ba5af1aa-512e-f1f8-d4c9-c7ce57ae6a66" class="op-btn-wrapper prica-btn projects-btn btn-white w-inline-block dropdown" id="dropdown">
                <div class="op-section-list op-section-btn projects-btn op-btn-white2 btn-text-white dropdown-toggle">Преузмите финансијске извештаје</div>
  ...
  <div data-animation="default" class="navbar w-nav" data-easing2="ease" data-easing="ease" data-collapse="all" style="background-color:rgb(255,255,255)" data-w-id="370ed3c5-772c-9479-2f21-b22ecd68c448" role="banner" data-no-scroll="1" data-duration="400" data-doc-height="1">
        ...
        <nav role="navigation" class="nav-menu w-nav-menu">
          <div class="container nav-menu-container">
            <div class="menu-links">
              ...
              <a href="finansijski-izvjestaj.php" aria-current="page" class="menu-link w-nav-link w--current">ФИНАНСИЈСКИ ИЗВЕШТАЈИ И ПЛАНОВИ</a>
            </div>
    ...
    <div class="container-2">
      <div class="w-row">
        ...
        <div class="column-13 w-col w-col-2">
          ...
          <a href="finansijski-izvjestaj.php" aria-current="page" class="footer-link w--current">Финансијски извештаји</a>
        </div>
