...
CREATE TABLE `files` (
  `fileid` int NOT NULL,
  `filelocation` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `filename` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `filetype` tinyint NOT NULL,
  `fileextension` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `filedate` datetime NOT NULL,
  `uploadedFileName` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
...
CREATE TABLE `vesti` (
  `id` int NOT NULL,
  `naslov` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
